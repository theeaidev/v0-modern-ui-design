              ...
              <TabsContent value="details" className="space-y-4 pt-6">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  <div>
                    ...
                    {listing.subcategory && <p className="text-muted-foreground">{listing.subcategory.name}</p>}
                  </div>
                        ...
                        <span className="ml-1">
                          ...
                          {listing.price_type === "fixed"
                            ...
                            : listing.price_type === "hourly"
                              ? "Por hora"
                              : listing.price_type === "daily"
                                ? "Por día"
                                : listing.price_type === "monthly"
                                  ? "Por mes"
                                  : listing.price_type === "variable"
                                    ? "Variable"
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">{listing.location || "No especificado"}</p>
                </div>

                {listing.phone && (
                  <div>
                    <h3 className="text-lg font-medium">Teléfono</h3>
                    <p className="text-muted-foreground">{listing.phone}</p>
                  </div>
                )}
              </TabsContent>
