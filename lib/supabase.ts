...
export function getSupabaseBrowserClient() {
  ...
  if (typeof window === "undefined") {
    console.log(
      "[SUPABASE CLIENT] Server-side rendering detected, creating new instance"
    );
  ...
  if (!browserClient) {
    ...
    try {
        ...
        process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY!,
        {
          ...
          cookies: {
            get(name) {
              ...
              console.log(
                `[SUPABASE CLIENT] Raw cookie value for ${name}:`,
                value
              );
      ...
      console.error(
        "[SUPABASE CLIENT] Error creating Supabase browser client:",
        error
      );
