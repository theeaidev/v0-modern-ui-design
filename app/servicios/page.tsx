...
export default function ServiciosPage() {
  ...
  useEffect(() => {
    ...
    if (filters.categorias.length === 1) {
      ...
      router.replace(`/servicios?categoria=${filters.categorias[0]}`, { scroll: false })
                              ...
                              <div className="flex items-center">
                                <div className="w-5 h-5 mr-2 flex items-center justify-center">
                                  <div
                                    ...
                                    ${filters.categorias.includes(category) ? "bg-primary text-primary-foreground" : "bg-transparent"}`}
                                    onClick={(e) => {
                                      e.stopPropagation()
                                  ...
                                  <div key={subcategory} className="flex items-center space-x-2 group">
                                    <div className="w-5 h-5 flex items-center justify-center">
                                      <div
                                        ...
                                        ${filters.subcategorias.includes(subcategory) ? "bg-primary text-primary-foreground" : "bg-transparent"}`}
                                        onClick={(e) => {
                                          e.stopPropagation()
